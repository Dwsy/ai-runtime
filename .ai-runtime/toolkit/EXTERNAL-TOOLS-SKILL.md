...
### 工具详解
- **[fzf使用指南](references/external/fzf.md)** - 模糊查找器的完整指南
- **[eza使用指南](references/external/eza.md)** - 现代化文件列表工具
- **[bat使用指南](references/external/bat.md)** - 语法高亮文件查看器
- **[ripgrep使用指南](references/external/ripgrep.md)** - 高性能代码搜索工具
- **[zoxide使用指南](references/external/zoxide.md)** - 智能目录跳转工具
- **[jq使用指南](references/external/jq.md)** - JSON命令行处理器

### 整合指南
- **[外部工具整合详解](references/external-integration.md)** - 如何整合更多第三方工具
...
- **[内部工具详解](references/internal-tools.md)** - AI Runtime自主创建的工具
- **[宪法文档](../constitution.md)** - 治理原则和约束
